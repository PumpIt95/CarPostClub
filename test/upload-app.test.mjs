...
test("Marketplace draft infers common uploaded body styles when source feed is blank", async () => {
  const bodyStyleCases = [
    ...
    {
      expectedBodyStyle: "Hatchback",
      car: {
        dealershipId: "15",
        inventoryTypeId: "2",
        vin: "KNDCS3LF2S5282849",
        stockNumber: "U6477",
        title: "Used 2025 Kia Niro Just Arrived & Fully Certified EX, PHEV, Navigation",
        year: "2025",
        make: "Kia",
        model: "Niro",
        trim: "EX PHEV",
        ...
        fuelType: "Hybrid",
        transmission: "Automatic",
        detailUrl: "https://www.oregans.com/inventory/Used-2025-Kia-Niro-U6477/",
      },
    },
    {
      expectedBodyStyle: "Hatchback",
      car: {
        dealershipId: "15",
        inventoryTypeId: "1",
        vin: "KNDCR3L19T5157672",
        stockNumber: "A10460",
        title: "New 2026 Kia Niro EV Wind+",
        year: "2026",
        make: "Kia",
        model: "Niro EV",
        trim: "Wind+",
        ...
        fuelType: "Electric",
        transmission: "Automatic",
        detailUrl: "https://www.oregans.com/inventory/New-2026-Kia-Niro-EV-Wind-A10460/",
      },
    },
    {
      expectedBodyStyle: "Hatchback",
      car: {
        dealershipId: "15",
        inventoryTypeId: "1",
        vin: "3KPFW4DE0TE100019",
        stockNumber: "A10419",
        title: "New 2026 Kia K4 Hatchback EX+",
        year: "2026",
        make: "Kia",
        model: "K4 Hatchback",
        trim: "EX+",
        ...
        fuelType: "Gas",
        transmission: "Automatic",
        detailUrl: "https://www.oregans.com/inventory/New-2026-Kia-K4-Hatchback-EX-A10419/",
      },
    },
    {
      expectedBodyStyle: "SUV",
      car: {
        dealershipId: "15",
        inventoryTypeId: "1",
        vin: "KNDPVCAG0T7123456",
        stockNumber: "A10389",
        title: "New 2026 Kia Sportage Hybrid SX AWD",
        year: "2026",
        make: "Kia",
        ...
        fuelType: "Hybrid",
        transmission: "Automatic",
        detailUrl: "https://www.oregans.com/inventory/New-2026-Kia-Sportage-Hybrid-SX-A10389/",
      },
    },
    {
      expectedBodyStyle: "Minivan",
      car: {
        dealershipId: "15",
        inventoryTypeId: "1",
        vin: "KNDNC5KA8T6176991",
        stockNumber: "A10435",
        title: "New 2026 Kia Carnival Hybrid EX",
        year: "2026",
        make: "Kia",
        ...
        fuelType: "Hybrid",
        transmission: "Automatic",
        detailUrl: "https://www.oregans.com/inventory/New-2026-Kia-Carnival-Hybrid-EX-A10435/",
      },
    },
    {
      expectedBodyStyle: "Sedan",
      car: {
        dealershipId: "15",
        inventoryTypeId: "1",
        vin: "KNAD54D36T6014482",
        stockNumber: "A10196",
        title: "New 2026 Kia EV4 GT-Line",
        year: "2026",
        make: "Kia",
        model: "EV4",
        trim: "GT-Line",
        ...
        fuelType: "Electric",
        transmission: "Automatic",
        detailUrl: "https://www.oregans.com/inventory/New-2026-Kia-EV4-GT-Line-A10196/",
      },
    },
  ];
  ...
  try {
    ...
    for (const { car, expectedBodyStyle } of bodyStyleCases) {
      const marketplaceDraft = await getJson(
        harness,
        `/api/marketplace-draft?dealershipId=15&inventoryTypeId=${car.inventoryTypeId}&vin=${car.vin}`,
      );
